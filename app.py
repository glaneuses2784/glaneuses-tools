...
CUSTOMS_RATES = {
    "食器（磁器製）":              {"アメリカ": 0.308, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "置物（磁器製）":              {"アメリカ": 0.360, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "花瓶・壺（磁器製）":          {"アメリカ": 0.360, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "ガラス装飾・ボウル":          {"アメリカ": 0.160, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "ガラスグラス（クリスタル）":  {"アメリカ": 0.160, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "ガラスグラス（非クリスタル）":{"アメリカ": 0.169, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "バッグ・革小物":              {"アメリカ": 0.200, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "オルゴール・自動機械":        {"アメリカ": 0.132, "イギリス": 0.0, "EU（イタリア等）": 0.0},
    "アンティーク（100年以上）":   {"アメリカ": 0.000, "イギリス": 0.0, "EU（イタリア等）": 0.0},
}
